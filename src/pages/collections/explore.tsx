...
const ExploreCollectionsPage: NextPage<AuthenticatedPageProps> = ({ collections }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    <div className="px-4 py-5 md:px-5 mb-10 flex items-center justify-center h-full overflow-y-scroll overflow-x-hidden">
      <div className="md:p-4 text-2xl flex flex-col w-full h-screen text-gray-700 font-medium dark:text-gray-200 md:w-11/12">
        <h1 className="text-3xl md:text-5xl my-16">Explore Collections</h1>
        {data && data.length && (
