...
const Home: NextPage = ({ collections }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  return (
    <div className="my-10">
      ...
      <main className="container flex flex-col md:gap-5 items-center justify-center min-h-[calc(100vh-310px)] p-4 mx-auto dark:text-gray-200 text-2xl text-gray-700 md:min-w-[calc(83%)]">
